...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      stream: FirebaseFirestore.instance.collection('cafe_mall').snapshots(),
      builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
        ...
        return new ListView(
          children: snapshot.data.docs.map((DocumentSnapshot document) {
            return new ListTile(
              title: new Text(document.data()['cafe_name']),
              subtitle: new Text(document.data()['cafe_address']),
            );
          }).toList(),
        );
      },
